...
////////////////////////////
// First is the geometry pass where we are interested in material properties
...
//and now attributes and uniforms for our second pass where we do lighting
...
window.onload = function init() {
    ...
    //and now we wouldn't need that renderbuffer code below

    // this is where it was important to have a fixed layout specified in
    // fragment-shader-geometry.glsl so we can list them in the right order here
    gl.drawBuffers([
    ...
    gl.renderbufferStorage(gl.RENDERBUFFER, gl.DEPTH_COMPONENT32F, texWidth, texHeight);
...
function render(){
    ...
    //Extra example: what if we wanted to read out of a depth texture?
